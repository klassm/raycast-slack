...
export async function loadIdentityCached(credentials: Credentials, teamId: string): Promise<Identity> {
  return getCachedData<Identity>(`slack-identity-${teamId}`, async () => loadIdentity(credentials), {
